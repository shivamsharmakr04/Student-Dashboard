...
export const CourseCard: React.FC<CourseProps> = ({ course, onResume }) => {
  ...
  return (
    <div className="group relative rounded-2xl bg-white border border-slate-200/80 p-5 shadow-sm hover:shadow-xl hover:border-indigo-400 transition-all duration-300 flex flex-col justify-between">
      {/* Top Banner & Category */}
      <div>
